...
#             self.product_tree.insert('', tk.END, values=[record[0], record[1], record[2], record[3]])
        ...
        location_label = tk.Label(self.function_frame, text='Order location:', fg=my_config.FOREGROUND, bg=my_config.BACKGROUND)
        ...
        self.id_product_entry.grid(row=0, column=0)
        self.quantity_entry = tk.Entry(self.function_frame, width=30, bg=my_config.FOREGROUND)
        self.quantity_entry.grid(row=1, column=0)
        self.location_entry = tk.Entry(self.function_frame, width=30, bg=my_config.FOREGROUND)
        self.location_entry.grid(row=2, column=0)

        # buttons
        place_order_button = tk.Button(self.function_frame, text='Place order',
                                       bg=my_config.FOREGROUND, command=self.new_page, width=16)
        place_order_button.grid(row=4, column=0)
        details_button = tk.Button(self.function_frame, text='Details',
                                   bg=my_config.FOREGROUND, command=self.new_page, width=16)
        details_button.grid(row=5, column=0)
